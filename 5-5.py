...
def conv_cal(img,filter):
    ...
    for i in range(2,h-2):
        for j in range(2,w-2):
            img_filter[i][j]=img[i-2][j-2]*filter[0][0]+img[i-2][j-1]*filter[0][1]+img[i-2][j]*filter[0][2]+img[i-2][j+1]*filter[0][3]+img[i-2][j+2]*filter[0][2]+\
                    img[i-1][j-2]*filter[0][0]+img[i-1][j-1]*filter[0][1]+img[i-1][j]*filter[0][2]+img[i-1][j+1]*filter[0][3]+img[i-1][j+2]*filter[0][2]+\
                    img[i][j-2]*filter[0][0]+img[i][j-1]*filter[0][1]+img[i][j]*filter[0][2]+img[i][j+1]*filter[0][3]+img[i][j+2]*filter[0][2]+\
                    img[i+1][j-2]*filter[0][0]+img[i+1][j-1]*filter[0][1]+img[i+1][j]*filter[0][2]+img[i+1][j+1]*filter[0][3]+img[i+1][j+2]*filter[0][2]+\
                    img[i+2][j-2]*filter[0][0]+img[i+2][j-1]*filter[0][1]+img[i+2][j]*filter[0][2]+img[i+2][j+1]*filter[0][3]+img[i+2][j+2]*filter[0][2]
    return img_filter
...
krisch1=np.array([[1,2,4,2,1],
                  [1,2,4,2,1],
                  [-4,-8,-16,-8,-4],
                  [1,2,4,2,1],
                  [1,2,4,2,1]])

krisch2=np.array([[1,1,-4,1,1],
                  [2,2,-8,2,2],
                  [4,4,-16,4,4],
                  [2,2,-8,2,2],
                  [1,1,-4,1,1]])

krisch3=np.array([[2,1,1,2,-4],
                  [1,2,4,-8,2],
                  [1,4,-16,4,1],
                  [2,-8,4,2,1],
                  [-4,2,1,1,2]])

krisch4=np.array([[-4,2,1,1,2],
                  [2,-8,4,2,1],
                  [1,4,-16,4,1],
                  [1,2,4,-8,2],
                  [2,1,1,2,-4]])
