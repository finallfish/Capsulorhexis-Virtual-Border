...
path = 'eyedata/0001.jpg'

original_img = io.imread(path)
gray_img = cv2.cvtColor(original_img, cv2.COLOR_BGR2GRAY)
gray_img = cv2.resize(gray_img,(360,288))
gray_img = cv2.resize(gray_img,(180,144))
...
# 用霍夫变换检测圆
circles = cv2.HoughCircles(edge_img, cv2.HOUGH_GRADIENT, 1, 600, param1=200, param2=50, minRadius=10, maxRadius=50)
